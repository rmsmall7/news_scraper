...
app.get("/api/fetch", function(req, res) {
  ...
  $("article").each(function(i, element) {
    // this will save an empty result
    var result = {};
  ...
  // if success during scrape- message is sent to client
  res.send("Scrape completed!!");
});
});

// retreive notes from an article
